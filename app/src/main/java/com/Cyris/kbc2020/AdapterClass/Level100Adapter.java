...
public class Level100Adapter extends RecyclerView.Adapter<Level100Adapter.TopScoreViewHolder> {
    ...
    public Level100Adapter(Context ctx, List<String> list, LinearLayout layout)
    {
        context = ctx;
        topList = list;
        noRecord = layout;
    ...
    public void onBindViewHolder(@NonNull TopScoreViewHolder holder, int position) {
        ...
        holder.highScore.setText(topList.get(position));
        holder.highScoreCash.setText("Level 43");
    }
